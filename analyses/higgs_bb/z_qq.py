...
def build_graph(df, dataset):
    ...
    df = df.Define("reco_z_jet", "jet_tlv[jet_indx[1]]+jet_tlv[jet_indx[1]]")
...
if __name__ == "__main__":
    ...
    functions.build_and_run(datadict, datasets_to_run, build_graph, f"output_h_bb_qq_40GeV_flavourtag.root", args, norm=True, lumi=7200000)
